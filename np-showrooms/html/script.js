...
$(document).on("click", "#purchase", function () {
    ...
    canPress = false
    var boton22 = document.getElementById("purchase");
...
$(document).on("click", "#photo", function () {
    ...
    console.log('js ac')
    $.post('https://np-showrooms/photo', JSON.stringify({ model: cars[selectedId].model, price:cars[selectedId].price, zoneName: zone }), function(cb){});
});
