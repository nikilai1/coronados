...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(473.0834, -987.4509, 25.7346, 91.0607),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(474.5348, -990.9174, 25.7347),
            vector3(470.7196, -991.2682, 25.8332),
            vector3(470.9606, -984.2180, 25.7347),
            vector3(473.8570, -984.2736, 25.7347)
        }
    },
    {
        job = "mechanic",
        coords = vector4(-339.5618, -161.4826, 44.5875, 287.6784),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-343.5132, -159.2228, 44.5885),
            vector3(-342.0974, -162.1793, 44.5885),
            vector3(-340.8068, -163.0118, 44.5885),
            vector3(-335.5717, -160.8052, 44.5885)
        }
    },
    {
        job = "ambulance",
        coords = vector4(-440.2538, -310.2209, 35.3, 286.5788),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-445.1096, -309.7563, 35.3),
            vector3(-443.3792, -314.2366, 35.3),
            vector3(-433.3230, -309.9579, 35.3),
            vector3(-435.1082, -305.1025, 35.3)
        }
    }
}
