...
Config.empresas = {
	["trucker_1"] = {															-- ID
		['nome'] = "Port",														-- Name
		['coordenada'] = {1240.19,-3179.84,7.13},								-- Coordinate to open the menu
...
Config.contratos = {
	...
	['preco_por_km_min'] = 60,				-- Minimum price per kilometer of the contract
	['preco_por_km_max'] = 90,				-- Maximum price per kilometer of the contract
	...
	['max_contratos_ativos'] = 12,				-- Maximum of contracts that can be active, this means that when generating a contact that exceeds this number, the oldest contract will be deleted
	['camiones'] = {							-- List of trucks that are generated in contracts
	...
	['cargas'] = {
		...
		{ carga = "trailers", nome = "Tile transport", def = {0,0,0}},
		{ carga = "trailers", nome = "Rail transport", def = {0,0,0}},
		{ carga = "trailers", nome = "Transport of used packaging", def = {0,0,0}},
		{ carga = "trailers", nome = "Floor plate transport", def = {0,0,0}},
		{ carga = "trailers", nome = "Ceramic transport", def = {0,1,0}},
		{ carga = "trailers", nome = "Scrap transport", def = {0,0,0}},
...
Config.trabalhos = {
	...
	['valor_inicial_max'] = 120,			-- Maximum initial contract profit
	['porcentagem_bonus_habilidades'] = 5,	-- Percentage that will be generated from profit for each skill that the driver has
...
Config.multiplicador_venda = 0.3	-- Value you receive when selling the used truck
...
Config.blips = {
	{1240.19,-3179.84,7.13,7.48,4,"Camioneros",0.5 },
}