...
RegisterCommand('ooc', function(source, args, rawCommand)
    ...
    TriggerClientEvent('cc-rpchat:addMessage', -1, 'white', 'fa-solid fa-globe', 'OOC | '..playerName, msg)
end, false)
...
RegisterCommand('me', function(source, args, rawCommand)
    ...
    TriggerClientEvent('cc-rpchat:addProximityMessage', -1, '#ff7700', 'fa-solid fa-person', 'Me | '..playerName, msg, source, GetEntityCoords(GetPlayerPed(source)))
...
RegisterCommand('twt', function(source, args, rawCommand)
    ...
    TriggerClientEvent('cc-rpchat:addMessage', -1, '#44aef5', 'fa-brands fa-twitter', '@'..playerName, msg)
end, false)
